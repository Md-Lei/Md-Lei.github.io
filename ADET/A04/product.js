var products = [
...

    {
        ...
        "contents": [
            ...
            {
                "name": "Chicken Sandwich", "code": "CHS",
                "img": "chicken.png",
                "price": 150
            },
            {
...
function loadCategories() {
  ...
  <div onclick="loadProducts('`+ index + `')" class="card mx-1 customized-button p-3 text-center justify-content-center" style="background-color:` + product.color + `">
